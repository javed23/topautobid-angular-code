...
export class ProfileComponent implements OnInit {
  ...
  title: string = 'Dealer Profile';
  breadcrumbs: any[] = [{ page: 'Home', link: '#' }, { page: 'Profile', link: '' }]
  profileForm: FormGroup;
  submitted: boolean = false;


  constructor(private location: Location, private titleService: TitleService, private formBuilder: FormBuilder, private alertService: AlertService, private userAuthService: UserAuthService, private pageLoaderService: PageLoaderService) {
