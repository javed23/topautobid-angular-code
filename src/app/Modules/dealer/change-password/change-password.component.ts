...
export class ChangePasswordComponent implements OnInit {
  ...
  title: string = 'Dealer Change Password';
  breadcrumbs: any[] = [{ page: 'Home', link: '/dealer/home' }, { page: 'Profile', link: '/dealer/dealer-profile' }, { page: 'Change password', link: '' }]
    ...
    this.changePasswordForm = this.formBuilder.group({
      ...
      previous_password: [
        ...
        Validators.compose([
          ...
          Validators.minLength(10)]), this.isPasswordCorrect.bind(this)
  ...
  isPasswordCorrect(control: AbstractControl): Promise<{ [key: string]: any } | null>
    ...
    return this.userAuthService.dealerIsPasswordCorrect({ previous_password: control.value })
      .pipe(
